...
- 全アプリUI展開・工程3: PCサイドNAV／スマホドロワー設計
...
- 工程3として、PCサイドNAVとスマホ用グループ化ドロワーの共通定義・情報設計を開始する。
- `dashboard` と `performance` を試験適用先とし、権限別メニューと現在位置表示を設計する。
...
- 工程3の開始時設計として、現行メニューのURL・名称・権限条件を共通定義へ写像する。
- `dashboard` と `performance` の上部NAVを、PCサイドNAV／スマホドロワーへ試験置換する。
- PC／モバイル、管理者／報告者、現在位置、キーボード操作を検証する。
- 工程3の完了後、工程4の共通UI基盤へ進む。
