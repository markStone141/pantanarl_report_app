...
- 工程13「新UI全画面適用の再監査・完成」を進行中。工程13-0と13-1を完了し、工程13-2の第1単位としてPerformance管理者CRUD画面を共通シェルへ移行した。
...
- 工程13-2の第1単位として、全体エントリー、過去実績入力、戻り・増額、日次編集、決済編集を共通シェルへ移行した。
- 次は工程13-2の第2単位「個人実績・履歴」を進める。
...
- 工程13-2の第2単位として、個人実績・個人履歴の旧ヘッダー／旧NAVを共通 `app_navigation.html` へ移行する。
- その後、工程13-2の第3単位「あと一歩ノート」を進める。
