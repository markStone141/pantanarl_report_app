...
- 工程13「新UI全画面適用の再監査・完成」を進行中。工程13-4を完了し、次は工程13-5の横断監査・完成判定。
...
- 工程13-5として、名前付き画面URL、権限、PC／モバイル、キーボード、戻る、フォーム、AJAX、二重送信防止を横断監査する。
- 全テスト、Django check、migration、BOM、JavaScript構文、EOF、差分監査を実行し、PC／モバイル確認画像を更新する。
