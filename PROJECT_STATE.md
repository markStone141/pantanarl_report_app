...
- 工程11の変更をGitHubへPUSHし、公開環境でPC／モバイルの最終視覚確認を行う。
...
- 自己完結化した `docs/button-ui-preview.html` をチャットから直接開き、変更前後、6分類、モバイルタブ、注意状態を確認する。
- 見た目の承認後、新しいGit bundleを作成し、GitHubへPUSHする。
