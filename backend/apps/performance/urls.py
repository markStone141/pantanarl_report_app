...
from .views import (
    ...
    performance_login,
    performance_logout,
    performance_past_entry_create,
    performance_transaction_delete,
...
urlpatterns = [
    ...
    path("transactions/<int:transaction_id>/delete/", performance_transaction_delete, name="performance_transaction_delete"),
