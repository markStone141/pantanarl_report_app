...
class PerformanceManagementTests(AppTestMixin, TestCase):
    ...
    def test_performance_index_and_history_show_today_transaction_and_mail_details(self):
        ...
        self.assertContains(index_response, "決済 <span class=\"performance-record-tab-count\">1件</span>", html=True)
        self.assertContains(index_response, "メール <span class=\"performance-record-tab-count\">1件</span>", html=True)
        ...
        self.assertContains(index_response, 'class="card performance-activity-group performance-activity-group-active"')
        self.assertContains(index_response, 'class="card performance-activity-group performance-activity-group-finished"')
