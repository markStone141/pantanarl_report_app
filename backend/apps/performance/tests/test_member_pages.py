...
class MemberPagesTests(PerformanceTestBase):
    ...
    def test_performance_member_detail_shows_realtime_dashboard(self):
        ...
        self.assertContains(response, 'class="card ui-chart-card performance-trend-card', html=False)
        self.assertContains(response, 'class="performance-chart-card ui-chart-frame', html=False)
