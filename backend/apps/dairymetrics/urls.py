...
urlpatterns = [
    ...
    path("entry-v2-transaction/", views.entry_form_v2_transaction, name="dairymetrics_entry_v2_transaction_demo"),
    path("metrics-v2/", views.metrics_v2, name="dairymetrics_metrics_v2_demo"),
