...
class MemberMetricTransactionReactionNotificationState(models.Model):
...
class MemberPeriodMetricTarget(models.Model):
    ...
    target_cs_count = models.PositiveIntegerField(default=0)
    target_refugee_count = models.PositiveIntegerField(default=0)
