...
def build_member_dashboard(member, *, today=None):
    ...
    for department in departments:
        ...
        active_days = MemberDailyMetricEntry.objects.filter(member=member, department=department, entry_date__range=(month_start, today)).count() or 1
