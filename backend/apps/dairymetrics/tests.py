...
class DairyMetricsV2DemoTests(AppTestMixin, TestCase):
    ...
    def test_metrics_v2_demo_renders_member_sections(self):
        ...
        self.assertContains(response, 'role="tablist"', html=False)
        self.assertContains(response, 'data-metrics-v2-summary-tab="personal"', html=False)
        self.assertContains(response, 'data-metrics-v2-summary-tab="overall"', html=False)
        self.assertContains(response, 'data-metrics-v2-summary-panel="personal"', html=False)
        self.assertContains(response, 'data-metrics-v2-summary-panel="overall"', html=False)
